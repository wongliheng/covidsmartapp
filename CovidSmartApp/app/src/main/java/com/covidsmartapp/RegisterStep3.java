            ...
            db.collection("users")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(RegisterStep3.this, "Account successfully created", Toast.LENGTH_LONG).show();
                            mAuth.signOut();
                            finish();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(RegisterStep3.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
